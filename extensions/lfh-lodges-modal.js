...
export const LFH_LODGES = {
  bell2: {
    ...
    terrain: {
      ...
      commute: 'Lodge departures. 5 min flights to closest runs.',
      snowfall: '10-15 meters per winter.',
  ...
  ripley: {
    ...
    features: {
      ...
      helipad: 'In town, shuttle to staging areas (15-40 min).',
    },
    terrain: {
...
const COMPARISON_CATEGORIES = [
  ...
  {
    label: 'Snowfall',
    bell2: '10-15 meters per winter.',
    ripley: '15-25 meters per winter.',
    icon: '❄',
  },
  {
