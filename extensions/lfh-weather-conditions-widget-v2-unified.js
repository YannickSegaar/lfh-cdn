...
const DEFAULT_HERO_IMAGE =
  'https://yannicksegaar.github.io/lfh-cdn/images/weather_report_background.jpg';
...
export const LFHWeatherConditionsWidgetV2Unified = {
  ...
  match: ({ trace }) =>
    ...
    trace.type === 'ext_weather_conditions_v2' ||
    trace.payload?.name === 'ext_weather_conditions_v2_unified' ||
    trace.payload?.name === 'ext_weather_conditions_v2',
