...
const resources = [
  {
    id: 'tours',
    title: 'Explore Tours',
    description: 'View all heliskiing tour packages',
    url: 'https://lastfrontierheli.com/tours/',
    icon: 'tours',
  },
  {
    id: 'faq',
...
export const LastFrontierBrowserSelfService_v4_Unified = {
  ...
  match: ({ trace }) =>
    ...
    trace.type === 'ext_browserSelfService_v4' ||
    trace.payload?.name === 'ext_browserSelfService_v4_unified' ||
    trace.payload?.name === 'ext_browserSelfService_v4',
